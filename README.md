...
```text
dist/android-vcam-manager-v0.5.0-dev.36-debug.apk
dist/android-vcam-camera2-test-v0.5.0-dev.36-debug.apk
dist/android-vcam-module-v0.5.0-dev.36.zip
dist/android-vcam-supported-v0.5.0-dev.36.json
```
...
[the dev.36 release snapshot](docs/releases/supported-dev36.md). The first
