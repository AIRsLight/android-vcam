...
| 14 | stable AIDL v2 with OEM variants | AIDL v2 frontend, CameraService integration and product policy | Soong build plus offline OEM ABI/transaction guard and pass-through bridge complete; activation pending |
