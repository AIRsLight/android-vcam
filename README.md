...
```text
dist/android-vcam-manager-v0.5.0-dev.35-debug.apk
dist/android-vcam-camera2-test-v0.5.0-dev.35-debug.apk
dist/android-vcam-module-v0.5.0-dev.35.zip
dist/android-vcam-supported-v0.5.0-dev.35.json
```
...
[the dev.35 release snapshot](docs/releases/supported-dev35.md). The first
