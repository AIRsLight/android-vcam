...
| 14 | stable AIDL v2 with OEM variants | AIDL v2 frontend, CameraService integration and product policy | AIDL frame delivery, undeclared notification, FCM 8 declaration, internal IDs 1000/1001, local/RTSP target writes, final-resolution YUV output, packaged manager-independent backend, ordinary Camera2 coexistence and automatic next-boot rollback qualified on NX769J. Segmented public-to-internal ID rewriting, CaptureRequest repair, listener/status filtering, death-notification proxying and remove-listener identity preservation pass AOSP r23 host tests and an NX769J cold boot: scoped public 0/1 reached internal 1000/1001, direct internal enumeration was hidden, and the unscoped OEM camera stayed physical. Repeated network-source retry, broader third-party coverage and production OEM integration remain pending |
